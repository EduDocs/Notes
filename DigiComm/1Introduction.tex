...
Fig.~\ref{figure:BlockDiagram} also alludes to the natural symmetry present in digital communication systems.
...
An exception to this rule is quantization; once performed, a small part of the original information is lost.
Quantization cannot be undone, yet the amount of distortion introduced through this process can easily be controlled.}
