...
\end{center}
\end{figure}
A succession of power spectral densities can be found in Figure~\ref{figure:Sampling}.
...
Therefore, a Gaussian process is completely determined by its mean function $m_X (t)$ and its autocorrelation function $R_{XX} (t_1,t_2)$.
