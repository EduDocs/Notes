...
Using set-builder notation, we can also define the \defn{set theory}{natural numbers} $\mathbb{N}$ and the \defn{set theory}{rational numbers} $\mathbb{Q}$ with
\begin{align*}
...
\end{align*}
It is worth noting that this definition works well if the index set if finite, countably infinite, or even uncountably infinite.
