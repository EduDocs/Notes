...
\end{definition}
% \gpt{Suggested global cut/paste fix for this frame: replace ``disjoint'' by ``having trivial intersection.''  Subspaces always share the zero vector, so they are not disjoint as sets.}
