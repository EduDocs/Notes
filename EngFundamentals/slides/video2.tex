...
\begin{frame}<1-3> \frametitle{\bookref{subsection:Quantifiers}: Propositions and Predicates}
...
\begin{frame}<1-4> \frametitle{\bookref{subsection:Quantifiers}: Quantifiers}
...
\begin{frame}<1-5> \frametitle{\bookref{subsection:Quantifiers}: Multiple Quantifiers}
...
\begin{frame}<1-6> \frametitle{\bookref{subsection:Quantifiers}: Relationships Between Multiple Quantifiers}
...
\gpt{Suggested cut/paste clarification from the revised book: ``There are eight syntactic choices, but commuting two universal quantifiers and commuting two existential quantifiers leaves six distinct quantified statements.''}
...
\gpt{Suggested replacement for the predicate-logic claim: ``First-order logic is complete in the sense that every logically valid formula is provable, and validity is semidecidable.  This does not mean that every first-order theory is complete or that validity is decidable.''}
...
\begin{frame}<1-6> \frametitle{\bookref{section:StrategiesForProofs}: Strategies for Proofs}
...
\begin{itemize}
 \setlength\itemsep{3mm}
 \item Try the suggested reading: Course Notes EF \bookref{subsection:Quantifiers}--\bookref{section:StrategiesForProofs}
