...
% \gpt{Suggested cut/paste correction: say ``the unique bounded linear transformation $T^*\colon W\to V$.''  For bounded $T$ between Hilbert spaces, the adjoint is bounded as well.}
\begin{equation*}
