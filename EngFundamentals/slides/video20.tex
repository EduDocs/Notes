...
\title{ECE 586: Vector Space Methods \\ Lecture 20: Four Fundamental Subspaces}
...
\begin{tikzpicture}[overlay,remember picture,shift={(11.5,2.75)}]
  \node at (0,0) {\includegraphics[width=45mm]{strang_fig1.png}};
\end{tikzpicture}

\end{frame}


\begin{frame}{6.5: The Four Fundamental Subspaces: General Case}
...
\begin{equation*}
\left\langle T \vecnot{v} | \vecnot{w} \right\rangle_W
= \left\langle \vecnot{v} | T^* \vecnot{w} \right\rangle_V \quad\quad \text{for all }\vecnot{v} \in V, \vecnot{w} \in W
\end{equation*}
...
\begin{itemize}
\setlength\itemsep{1mm}
\item For all $\vecnot{w} \in W$, we have $\left\langle \vecnot{v} | T^* \vecnot{w} \right\rangle_V = 0$
\item $\vecnot{v} \in \mathcal{R}(T^*)^\perp$
\item $\vecnot{v} \in \mathcal{N}(T)$ because $\left\langle \vecnot{v} | T^* \vecnot{w} \right\rangle_V = \left\langle T \vecnot{v} | \vecnot{w} \right\rangle_W = 0$ for all $\vecnot{w} \in W$
...
\hspace*{-1mm}
\includegraphics[width=100mm]{strang_fig1.png}
...
\hspace*{-4mm}
\includegraphics[width=105mm]{strang_fig2}
...
\vspace{-1mm}
\hspace*{-1mm}
\includegraphics[width=95mm]{strang_fig3}
