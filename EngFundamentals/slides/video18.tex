...
% \gpt{Suggested cut/paste hypothesis: ``Let $Y,X_1,\ldots,X_n$ be zero-mean random variables with finite second moments.''  The displayed inner products and mean-squared error require this.}
...
\end{theorem}
% \gpt{Optional book figure for this frame: add \texttt{\string\usepackage\{tikz-3dplot\}} in the preamble and \texttt{\string\input\{../Figures/AR-Dual1.tex\}} near the theorem; it depicts the affine constraint set, $W^\perp$, and the minimum-norm solution.}
