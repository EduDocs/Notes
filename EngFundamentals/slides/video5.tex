...
\note{
	...
	\begin{enumerate}[<alert@+>]
		...
		\item Finally, in engineering mathematics, most functions satisfy a strong form of continuity known.  Read.  For example, this holds if the function's derivative exists and                                                             is bounded on $A$.
	\end{enumerate}
}
