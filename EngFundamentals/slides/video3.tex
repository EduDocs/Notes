...
\gpt{Suggested cut/paste repair from the revised book: ``Under unrestricted comprehension, the description $R=\{S\mid S\notin S\}$ would be required to define a set, producing Russell's contradiction.  The alleged `set of all sets' and similar self-containing examples are not legitimate sets in ZF/ZFC; the paradox motivates restricting set formation.''}
