...
Thus, the Riesz representation theorem (see Theorem~\ref{theorem:riesz_finite} for finite dimension and Theorem~\ref{theorem:FunctionalInnerProduct} for the general case) guarantees that there is a vector $\vecnot{u} \in X$ such that
