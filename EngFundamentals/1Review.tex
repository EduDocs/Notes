...
\begin{definition}
Let $A$ be a closed subset of complete metric space $(X,d)$ and $f: X \rightarrow X$ be a function.
...
Let $(X,d)$ be a metric space and $f$ be contraction on $A \subseteq X$.
