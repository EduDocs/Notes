...
The line that minimizes the sum of the squares of the vertical distances between the data points and the line is then given by
\begin{equation*}
...
It is closed because the set defined by $\vecnot{s} \geq \vecnot{0}$ is closed and the mapping $\vecnot{s} \mapsto B \vecnot{s}$ is continuous.
