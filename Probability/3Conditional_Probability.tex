...
In particular, it is reasonable to assign a probability of $1/3$ to each of the three outcomes that are still possible after learning the new information.
