...
The \emph{conditional expectation} of $Y$ given $X = x$ is simply the expectation of $Y$ with respect to the conditional PMF $p_{Y|X} (\cdot)$, \index{Conditional expectation}
\begin{equation*}
