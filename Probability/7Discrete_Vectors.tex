...
We center our exposition of random vectors around a simple case, pairs of random variables.
...
Note that, in computing the conditional expectation, we have used the memoryless property of the geometric random variable, $\Expect [ N | N \geq 5] = \Expect [ N | N > 4] = 4 + \Expect [ N ] = 6$.
\end{example}
...
We now turn to the question of determining the distribution of a sum of two independent random variables in terms of the marginal PMF of the summands.
