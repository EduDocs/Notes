...
\draw[very thick, <->, >=stealth'] (2.5,2) -- (2.5,-1.5) -- (6,-1.5);
\node at (2,1.75) {$\RealNumbers$};
\node at (2.125,0.25) {$Y$};
\node at (6,-2) {$\RealNumbers$};
\node at (4.25,-1.875) {$X$};

\draw[draw=black, fill=black] (5,-0.5) circle (0.75mm);
\draw[thick, dashed] (2.5,-0.5) -- (5,-0.5) -- (5,-1.5);
\draw[draw=black, fill=black] (3.5,1.5) circle (0.75mm);
\draw[thick, dashed] (2.5,1.5) -- (3.5,1.5) -- (3.5,-1.5);
...
\draw [thick, ->, >=stealth', shorten >= 1mm] (1,1.125) parabola (3.5,1.5);
