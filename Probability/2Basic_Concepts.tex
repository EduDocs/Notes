...
This insures that the outcome of an experiment is unique.\index{Distinct elements}\index{Mutually exclusive}
...
The second statement specifies the probability of the union of two events that are not necessarily mutually exclusive.
...
This result, which is sometimes called the \emph{Boole inequality}, asserts that the probability of at least one event occurring is no greater than the sum of the probability of the individual events.\index{Boole inequality}
