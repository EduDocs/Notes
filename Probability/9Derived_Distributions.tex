...
\addplot[red, mark=*] coordinates {
	(0,4)};
\draw[red,fill=red] (axis cs:1.75,0) rectangle (axis cs:3.25,0.15);
\node at (axis cs:2.5,0.75) {$g^{-1}(y)$};
\node at (axis cs:0.25,4.5) {$y$} ;
%\node at (axis cs:1.5,0.625) {$g^{-1}((-\infty, y])$};
\end{axis}
\end{tikzpicture}
\end{center}
...
\begin{axis}[
    ...
    xmajorgrids,
    ymajorgrids]
\draw[red,fill=red] (axis cs:0,0) rectangle (axis cs:0.075,4);
\draw[red,fill=red] (axis cs:0,0) rectangle (axis cs:3,0.1);
...
\addplot[black, dashed, thin] coordinates {
    ...
    (3,0) (3,4)};
\node at (axis cs:1.5,0.625) {$g^{-1}((-\infty, y])$};
\node[rotate=90] at (axis cs:0.375,2.5) {$(-\infty,y]$};
\end{axis}
\end{tikzpicture}
\end{center}
