...
If $X$ and $Y$ are independent random variables, the distribution of their sum $Z = X + Y$ can be obtained by using the \emph{convolution} operator. \index{Convolution}
