...
\begin{scope}
    ...
    \draw[thick,fill=red!20] (-1cm,-1cm) rectangle (1cm,1cm);
\end{scope}
\begin{scope}
    \clip (-0.5cm,-2cm) rectangle (0.5cm,2cm);
    \draw[thick,fill=black!10] (0,0) circle (1.5cm);
    \draw[thick,fill=green!20] (-1cm,-1cm) rectangle (1cm,1cm);
\end{scope}
\begin{scope}
    \clip (0.5cm,-2cm) rectangle (2cm,2cm);
    \draw[thick,fill=black!10] (0,0) circle (1.5cm);
    \draw[thick,fill=blue!20] (-1cm,-1cm) rectangle (1cm,1cm);
\end{scope}
\begin{scope}
    \clip (0,0) circle (1.5cm);
    \draw[thick] (-0.5cm,-2cm) rectangle (0.5cm,2cm);
\end{scope}
\coordinate [label=center:{$B$}] (B) at (0,-2cm);
\draw[->,thick,>=stealth'] (0cm,-1.75cm) to (0cm,-0.5cm);
