...
\end{psfrags}
\caption{Illustration of a set and its elements.}
\end{center}
\end{figure}
...
\end{psfrags}
\caption{Graphical representation of two sets, $S$ and $T$.}
\end{center}
\end{figure}
...
\begin{psfrags}
\psfrag{U}[c]{$S \cup T$}
\includegraphics[height=3.00cm]{Figures/1Chapter/union}
\end{psfrags}
\caption{The union of sets $S$ and $T$.}
\end{center}
\end{figure}
...
\begin{psfrags}
\psfrag{I}[c]{$S \cap T$}
\includegraphics[height=3.00cm]{Figures/1Chapter/intersection}
\end{psfrags}
\caption{The intersection of sets $S$ and $T$.}
\end{center}
\end{figure}
...
\begin{figure}[htb]
\begin{center}
\includegraphics[height=3.00cm]{Figures/1Chapter/setpartition}
\caption{A partition of $S$ is collection of sets that are disjoint and whose union is $S$.}
\end{center}
\end{figure}
...
\begin{psfrags}
\psfrag{D}[c]{$S - T$}
\includegraphics[height=3.00cm]{Figures/1Chapter/difference}
\end{psfrags}
\caption{The complement of $T$ relative to $S$.}
\end{center}
\end{figure}
...
\end{psfrags}
\caption{The order of set operation is important; parentheses should be employed to indicate precedence.}
\end{center}
\end{figure}
