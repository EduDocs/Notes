...
\begin{center}
\begin{tikzpicture}
\node[circle,draw=black,thick,minimum size=3cm,label=135:$S$] (S) at (-0.75,0) {};
\node[circle,draw=black,thick,minimum size=3cm,label=45:$T$] (T) at (0.75,0) {};
\end{tikzpicture}
...
\end{scope}
\coordinate [label=center:{$S_1$}] (S1) at (-1.5cm,0);
\coordinate [label=center:{$S_2$}] (S2) at (0,0);
\coordinate [label=center:{$S_3$}] (S3) at (1.5cm,0);
...
\end{scope}
\coordinate [label=center:{$S_1$}] (S1) at (5cm,0);
\coordinate [label=center:{$S_2$}] (S2) at (6cm,0);
\coordinate [label=center:{$S_3$}] (S3) at (7cm,0);
\end{tikzpicture}
