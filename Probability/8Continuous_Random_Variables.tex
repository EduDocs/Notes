...
We denote the derivative by $f_X (x)$ and call it the \emph{probability density function (PDF)} of $X$. \index{Probability density function}
...
A (continuous) \emph{uniform random variable} is such that all intervals of the same length contained within its support are equally probable. \index{Uniform random variable}
